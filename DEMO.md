...
1. **Frontmatter** — declares which tools the agent can use and which model
...
Local server registration is configured in `.vscode/mcp.json`, not in agent frontmatter.
...
Reference it in your agent tools list:
